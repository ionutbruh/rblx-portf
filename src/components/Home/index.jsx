                ...
                <div className="space-y-3">
                    ...
                    <div className="space-y-3" ref={buttonsRef}>
                        ...
                        <a className="inline-block">
                            <button className="flex items-center justify-center border-2 p-3 md:w-64 h-10 font-caviar text-white transition-all duration-300 transform hover:bg-discord-dark-blue hover:-translate-y-1">
